...
class SQLCliente 
{
	 ...
	 */
	public long adicionarCliente(PersistenceManager pm, long idCliente, String correo, String nombre) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaCliente () + "(idCliente, correo, nombre) values (?, ?, ?)");
        q.setParameters(idCliente, correo, nombre);
	...
	public List<Cliente> darClientes (PersistenceManager pm)
	{
		...
		List<Cliente> resp = (List<Cliente>) q.execute();
		return resp;
	}
