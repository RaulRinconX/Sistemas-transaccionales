...
class SQLApartamento 
{
	...
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaApartamento() + "(idOFERTAEXCLUSIVA, habitacionCompartida, precioNoche, amoblado, comidas, banoPrivado, costoServicios, idMiembro) values (?, ?, ?, ?, ?, ?, ?, ?)");
