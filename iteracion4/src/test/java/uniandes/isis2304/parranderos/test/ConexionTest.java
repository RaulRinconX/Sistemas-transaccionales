...
import uniandes.isis2304.AlohAndes.negocio.VOOrden;
    ...
    public void normalAccessTest ()
  	{
  	  	try
		{
			...
			aloha = new AlohAndes (openConfig (CONFIG_TABLAS_A));
			log.info ("Conexión realizada correstamente");
			log.info ("Cerrando la conexión");
			
			aloha.cerrarUnidadPersistencia ();
...
//			System.out.println (msg);
    ...
    public void baseDatosInaccesible ()
    {
		try
		{
			...
			aloha = new AlohAndes (openConfig (CONFIG_TABLAS_ERR_DS));
...
//			e.printStackTrace();
    ...
    public void usuarioInvalidoTest ()
    {
		try
		{
			...
			aloha = new AlohAndes (openConfig (CONFIG_TABLAS_ERR_USER));
...
//			e.printStackTrace();
    ...
    public void tablaInexistenteTest ()
    {
		...
		try
		{
			...
			aloha = new AlohAndes (openConfig (CONFIG_TABLAS_B));
		}
		catch (Exception e)
		{
//			e.printStackTrace();
