...
(
  ID_PROVEEDOR VARCHAR2(30 BYTE) NOT NULL,
  TIPO_PROVEEDOR VARCHAR2(20 BYTE) NOT NULL,
  NOMBRE VARCHAR2(20 BYTE) NOT NULL
...
ALTER TABLE OFERTAS
ADD CONSTRAINT OFERTAS_FK1 FOREIGN KEY
(
  ID_OPERADOR 
)
...
(
  ID_USUARIO VARCHAR2(30 BYTE) NOT NULL,
  TIPO_USUARIO VARCHAR2(20 BYTE) NOT NULL,
  NOMBRE VARCHAR2(20 BYTE) NOT NULL,
...
--- QUIERO QUE ME CREES UNA RESTRICCION EN LA FECHA DE INICIO DE LA RESERVA PARA QUE SEA MAYOR A LA FECHA DE INICIO DE LA OFERTA ---

CREATE OR REPLACE TRIGGER TRIGGER_RESERVAS
BEFORE INSERT ON RESERVAS
FOR EACH ROW
DECLARE
    FECHA_INICIO_OFERTA DATE;
BEGIN
    SELECT FECHA_INICIO INTO FECHA_INICIO_OFERTA FROM OFERTAS WHERE ID_OFERTA = :NEW.ID_OFERTA;
    IF :NEW.FECHA_INICIO < FECHA_INICIO_OFERTA THEN
        RAISE_APPLICATION_ERROR(-20000, 'LA FECHA DE INICIO DE LA RESERVA NO PUEDE SER MENOR A LA FECHA DE INICIO DE LA OFERTA');
    END IF;
END;
/
