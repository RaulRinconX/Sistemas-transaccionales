...
(TIPO_OFERTA IN('VIVIENDA UNIVERSITARIA', 'HABITACION DIARIA', 'HABITACION MENSUAL', 'APARTAMENTO','ESPORADICA', 'HOSTAL', 'HOTEL'))
ENABLE;
...
ALTER TABLE OFERTAS
ADD CONSTRAINT OFERTAS_CHK3 CHECK (DISPONIBLE IN(0,1))
ENABLE;
